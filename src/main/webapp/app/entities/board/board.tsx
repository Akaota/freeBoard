...
export const Board = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="board-heading" data-cy="BoardHeading">
        <Translate contentKey="freeBoardApp.board.home.title">Boards</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="freeBoardApp.board.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/board/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="freeBoardApp.board.home.createLabel">Create new Board</Translate>
          </Link>
        </div>
      </h2>
        ...
        {boardList && boardList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="freeBoardApp.board.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="freeBoardApp.board.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('category')}>
                  <Translate contentKey="freeBoardApp.board.category">Category</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('createdAt')}>
                  <Translate contentKey="freeBoardApp.board.createdAt">Created At</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('createdBy')}>
                  <Translate contentKey="freeBoardApp.board.createdBy">Created By</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="freeBoardApp.board.home.notFound">No Boards found</Translate>
            </div>
          )
        )}
      </div>
