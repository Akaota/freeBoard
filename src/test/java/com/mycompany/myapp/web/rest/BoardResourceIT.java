...
class BoardResourceIT {
    ...
    void putNewBoard() throws Exception {
        ...
        updatedBoard.title(UPDATED_TITLE).category(UPDATED_CATEGORY).createdAt(UPDATED_CREATED_AT).createdBy(UPDATED_CREATED_BY);
    ...
    void partialUpdateBoardWithPatch() throws Exception {
        ...
        partialUpdatedBoard.title(UPDATED_TITLE).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateBoardWithPatch() throws Exception {
        ...
        partialUpdatedBoard.title(UPDATED_TITLE).category(UPDATED_CATEGORY).createdAt(UPDATED_CREATED_AT).createdBy(UPDATED_CREATED_BY);
